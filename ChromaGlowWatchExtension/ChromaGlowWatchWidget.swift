// ChromaGlowWatchWidget.swift
// ChromaGlow — watchOS Widget Extension
//
...
struct ChromaGlowWatchEntryView: View {
...
struct ChromaGlowWatchWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        AppIntentConfiguration(
            ...
            ChromaGlowWatchEntryView(entry: entry)
...
#Preview("Circular", as: .accessoryCircular)       { ChromaGlowWatchWidget() } timeline: { previewEntry }
#Preview("Rectangular", as: .accessoryRectangular)  { ChromaGlowWatchWidget() } timeline: { previewEntry }
#Preview("Inline", as: .accessoryInline)            { ChromaGlowWatchWidget() } timeline: { previewEntry }
#if os(watchOS)
#Preview("Corner", as: .accessoryCorner)            { ChromaGlowWatchWidget() } timeline: { previewEntry }
#endif
