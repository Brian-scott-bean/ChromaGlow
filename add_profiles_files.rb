#!/usr/bin/env ruby
# add_profiles_files.rb
# Registers the 2026-07 Family Sharing Phase 3 (Profiles & Access) files in
...
APP_FILES = {
  'HueHome/Core/Models/GuestAccessModels.swift'        => ['HueHome', 'Core', 'Models'],
  'HueHome/Core/Dashboard/GuestAccessPolicy.swift'     => ['HueHome', 'Core', 'Dashboard'],
  'HueHome/UI/Profiles/ProfilesAccessView.swift'       => ['HueHome', 'UI', 'Profiles'],
  'HueHome/UI/Profiles/GuestProfileEditorView.swift'   => ['HueHome', 'UI', 'Profiles'],
  'HueHome/UI/Profiles/RoomAccessPicker.swift'         => ['HueHome', 'UI', 'Profiles'],
  'HueHome/UI/Components/GuestAccessBanner.swift'      => ['HueHome', 'UI', 'Components'],
}

TEST_FILES = {
  'HueHomeTests/GuestAccessModelsTests.swift'          => ['HueHomeTests'],
  'HueHomeTests/GuestAccessPolicyTests.swift'          => ['HueHomeTests'],
  'HueHomeTests/OrchestratorGuestAccessTests.swift'    => ['HueHomeTests'],
}
