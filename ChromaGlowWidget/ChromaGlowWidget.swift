...
struct ChromaGlowWidgetEntryView: View {
...
struct ChromaGlowWidget: Widget {
    let kind = "com.lightshade.app.ChromaGlowWidget"
    ...
    var body: some WidgetConfiguration {
        AppIntentConfiguration(
            ...
            ChromaGlowWidgetEntryView(entry: entry)
