#!/usr/bin/env ruby
# add_scene_sharing_files.rb
# Registers the 2026-07 scene-sharing files (QR share codec, share/import/scan UI)
# in the Xcode project. Idempotent — safe to re-run; silently skips files that
# don't exist yet and files already registered.
...
APP_FILES = {
  # Pure codec + QR rendering
  'HueHome/Core/Share/ScenePayloadCodec.swift' => ['HueHome', 'Core', 'Share'],
  'HueHome/Core/Share/SceneQRRenderer.swift'   => ['HueHome', 'Core', 'Share'],
  # Share / import / scan surfaces
  'HueHome/UI/Share/ShareSceneSheet.swift'     => ['HueHome', 'UI', 'Share'],
  'HueHome/UI/Share/ImportSceneSheet.swift'    => ['HueHome', 'UI', 'Share'],
  'HueHome/UI/Share/ScanSceneView.swift'       => ['HueHome', 'UI', 'Share'],
}

TEST_FILES = {
  'HueHomeTests/ScenePayloadCodecTests.swift'  => ['HueHomeTests'],
  'HueHomeTests/SceneQRRendererTests.swift'    => ['HueHomeTests'],
}
