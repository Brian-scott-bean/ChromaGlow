#!/usr/bin/env ruby
# add_invite_files.rb
# Registers the 2026-07 Share Invite (home-join) files in the Xcode project.
# Idempotent — safe to re-run; silently skips files that don't exist yet and
# files already registered. Same pattern as add_siri_intent_files.rb.
...
APP_FILES = {
  'HueHome/Core/Share/InvitePayloadCodec.swift' => ['HueHome', 'Core', 'Share'],
  'HueHome/UI/Invite/ShareInviteSheet.swift'    => ['HueHome', 'UI', 'Invite'],
  'HueHome/UI/Invite/JoinSharedHomeView.swift'  => ['HueHome', 'UI', 'Invite'],
}

TEST_FILES = {
  'HueHomeTests/InvitePayloadCodecTests.swift'  => ['HueHomeTests'],
}
