#!/usr/bin/env ruby
# add_tutorial_files.rb
# Registers the 2026-07 Welcome Tour files in the Xcode project.
# Idempotent — safe to re-run; silently skips files that don't exist yet and
# files already registered. Same pattern as add_invite_files.rb.
...
APP_FILES = {
  'HueHome/Core/Models/TutorialCatalog.swift'          => ['HueHome', 'Core', 'Models'],
  'HueHome/UI/Tutorial/WelcomeTourView.swift'          => ['HueHome', 'UI', 'Tutorial'],
  'HueHome/UI/Tutorial/TutorialIllustrationView.swift' => ['HueHome', 'UI', 'Tutorial'],
  'HueHome/UI/Tutorial/WelcomeTourWiring.swift'        => ['HueHome', 'UI', 'Tutorial'],
}

TEST_FILES = {
  'HueHomeTests/TutorialCatalogTests.swift'            => ['HueHomeTests'],
}
