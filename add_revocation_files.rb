#!/usr/bin/env ruby
# add_revocation_files.rb
# Registers the 2026-07 Family Sharing Phase 4 (revocation) files in the
# Xcode project. Idempotent — safe to re-run; silently skips files that
...
APP_FILES = {
  'HueHome/UI/BridgeManager/BridgeKeysView.swift'          => ['HueHome', 'UI', 'BridgeManager'],
  'HueHome/Core/Share/GuestRevocationService.swift'        => ['HueHome', 'Core', 'Share'],
  'HueHome/Core/Network/BridgeAuthorizationMonitor.swift'  => ['HueHome', 'Core', 'Network'],
}

TEST_FILES = {
  'HueHomeTests/WhitelistRedactionTests.swift'             => ['HueHomeTests'],
  'HueHomeTests/GuestRevocationServiceTests.swift'         => ['HueHomeTests'],
  'HueHomeTests/BridgeAuthorizationMonitorTests.swift'     => ['HueHomeTests'],
}
