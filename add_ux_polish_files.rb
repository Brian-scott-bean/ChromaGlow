#!/usr/bin/env ruby
# add_ux_polish_files.rb
# Registers the 2026-07 polish-program files (Rounds A + B: KeyboardState,
# LookPreview, EnvelopeStripView + their tests) in the Xcode project.
# Idempotent — safe to run after each round; silently skips files that don't
...
APP_FILES = {
  # Round A — keyboard smoothness
  'HueHome/UI/Components/KeyboardState.swift'      => ['HueHome', 'UI', 'Components'],
...
TEST_FILES = {
  'HueHomeTests/KeyboardStateTests.swift'          => ['HueHomeTests'],
  'HueHomeTests/MixerTrayMetricsTests.swift'       => ['HueHomeTests'],
  'HueHomeTests/LookPreviewMathTests.swift'        => ['HueHomeTests'],
  'HueHomeTests/EnvelopeStripMathTests.swift'      => ['HueHomeTests'],
}
