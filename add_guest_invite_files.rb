#!/usr/bin/env ruby
# add_guest_invite_files.rb
# Registers the 2026-07 Family Sharing Phase 2 (per-guest app key) files in
# the Xcode project. Idempotent — safe to re-run; silently skips files that
# don't exist yet and files already registered. Same pattern as
# add_invite_files.rb.
...
APP_FILES = {
  'HueHome/Core/Network/ApplicationKeyMinter.swift'  => ['HueHome', 'Core', 'Network'],
  'HueHome/Core/Keychain/GuestKeyStore.swift'        => ['HueHome', 'Core', 'Keychain'],
  'HueHome/Core/Share/GuestInviteSpec.swift'         => ['HueHome', 'Core', 'Share'],
  'HueHome/Core/Share/GuestInviteAcceptor.swift'     => ['HueHome', 'Core', 'Share'],
  'HueHome/UI/Invite/GuestInviteMintSheet.swift'     => ['HueHome', 'UI', 'Invite'],
  'HueHome/UI/Invite/GuestInviteAcceptView.swift'    => ['HueHome', 'UI', 'Invite'],
}

TEST_FILES = {
  'HueHomeTests/ApplicationKeyMinterTests.swift'     => ['HueHomeTests'],
  'HueHomeTests/GuestInvitePayloadCodecTests.swift'  => ['HueHomeTests'],
  'HueHomeTests/GuestKeyStoreTests.swift'            => ['HueHomeTests'],
  'HueHomeTests/GuestInviteAcceptorTests.swift'      => ['HueHomeTests'],
}
