#!/usr/bin/env ruby
# add_adjustrevamp_files.rb
# Registers the 2026-07 adjustment-settings-revamp files in the Xcode project.
...
APP_FILES = {
  # C2 — param controls extraction
  'HueHome/UI/Studio/StudioParamControls.swift'    => ['HueHome', 'UI', 'Studio'],
  # C6 — composer advanced layer sheet
  'HueHome/UI/Composer/ComposerLayerSheet.swift'   => ['HueHome', 'UI', 'Composer'],
  # C8 — per-card last-used param persistence
  'HueHome/Core/Effects/StudioParamStore.swift'    => ['HueHome', 'Core', 'Effects'],
  # C12 — room aggregate helper
  'HueHome/Core/Models/RoomAggregate.swift'        => ['HueHome', 'Core', 'Models'],
}

TEST_FILES = {
  'HueHomeTests/StudioParamCatalogTests.swift'     => ['HueHomeTests'],
  'HueHomeTests/ComposerControlCatalogTests.swift' => ['HueHomeTests'],
  'HueHomeTests/StudioParamStoreTests.swift'       => ['HueHomeTests'],
  'HueHomeTests/RoomAggregateTests.swift'          => ['HueHomeTests'],
}
