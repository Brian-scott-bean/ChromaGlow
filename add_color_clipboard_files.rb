#!/usr/bin/env ruby
# add_color_clipboard_files.rb
# Registers the 2026-07 light-card color copy/paste files (ColorClipboard model
# + tests) in the Xcode project. Idempotent — safe to re-run; silently skips
...
APP_FILES = {
  'HueHome/Core/Models/ColorClipboard.swift' => ['HueHome', 'Core', 'Models'],
}

TEST_FILES = {
  'HueHomeTests/ColorClipboardTests.swift'   => ['HueHomeTests'],
}
